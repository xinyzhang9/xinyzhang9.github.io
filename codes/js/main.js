	...
	function init() {
		...
		button.addEventListener('click',function( event ){
			if(count == 0){
				...
				render1();
				count++;
				document.getElementById('notice').innerHTML = '<p>舵主，当你读到这里，也许是我平生最紧张的时候了吧。从初见的怦然心动，到后来的念念不忘，我的世界早已离不开你。想让你每天都开心，像童话里的公主一样。记得你说小时候为爸爸挡酒，我听了心疼了好久。如果有我在，绝不会让你受到一点伤害！我会加倍努力，给你做最好吃的菜，为你写最浪漫的诗。陪你听小桥流水，陪你看长河落日。人生苦短，有你相伴一定不负此生。所以...和我在一起好不:)</p><p>By 花了好久才鼓起勇气的阳哥</p>';
				$("#notice").typewriter();
			}
			else{
				location.reload();
