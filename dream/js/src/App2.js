var App = function() {
    var _gui, _guiFields;
    var _engine;
    var _currPreset = Utils.getParameterByName("shape") || "wolf"; // initial preset
    var _currSimMode;
    var _uvAnim;
    var _tourMode = false;
    var _musicElem = document.getElementById("music");
    var tr,tg,tb,colorTimeout;
    ...
    _params.drawMat.uniforms.uColor2.value.x = 0;
    _params.drawMat.uniforms.uColor2.value.y = 0;
    _params.drawMat.uniforms.uColor2.value.z = 0;
    ...
    var _tourUpdate = (function() {
        ...
        var BETWEEN_PRESET = "wolf";
        var sequence = ["horse", "bear", "bison", "deer", "dog"];
        var timer = 0.0;
        var seqIdx = 0;
        var seqName;
